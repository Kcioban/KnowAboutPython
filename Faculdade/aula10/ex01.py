...
celsius_entry = tk.Button(
    convertApp, text="Converta de C para F", command=Fahrenheit)
celsius_entry.grid(row=1, column=0, padx=10, pady=10)
celsius_entry.configure(bg="#a9b6c1")

fahrenheit_entry = tk.Button(
    convertApp, text="Converta de F para C", command=Celsius)
fahrenheit_entry.grid(row=1, column=1, padx=10, pady=10)
fahrenheit_entry.configure(bg="#a9b6c1")

result_label = tk.Label(convertApp, text="", font=(
    "Inter", 12, "bold"), foreground="#000000", background="#767b80")
